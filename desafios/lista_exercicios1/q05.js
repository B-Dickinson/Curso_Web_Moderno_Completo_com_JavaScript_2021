...
function valorMonetario(value=0){
    return value.toLocaleString('pt-br',{style:'currency',currency:'BRL'});
}

console.log(valorMonetario(100));
console.log(valorMonetario(1000));
console.log(valorMonetario(10000));
console.log(valorMonetario());
console.log(valorMonetario(50));
console.log(valorMonetario(27597.50));